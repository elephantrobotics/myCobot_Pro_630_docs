...
第二步：启动机械臂
> 在终端运行HandInEyeCalib_Elephant.py文件
> <img src="../../resources/7-ExamplesRobotsUsing/3D/py.png" >

第三步：启动机械臂脚本后，就会开始自动标定

> 标定前确保相机能完整识别完整的棋盘格，以及标定过程中，棋盘格是固定的，不能发生移动。运行完成会得到20组数据。

![](https://note.youdao.com/yws/api/personal/file/WEBb224518b783ad3094a77403a4c3dbe04?method=download&shareKey=ea463be3e9ba5833c047e0ee8495e847)
...
<img src="../../resources/7-ExamplesRobotsUsing/3D/03.png" >
...
### 4.2 图像标注
在需要标注图片的文件夹新建class_name.txt(文件名不能更改)
<img src="../../resources/7-ExamplesRobotsUsing/3D/1.png" >

打开RVS，利用RVS自带图像标注工具对图像进行标注
<img src="../../resources/7-ExamplesRobotsUsing/3D/biaozhu.png" >

点击打开目录，选择要标注的图片的所在目录
