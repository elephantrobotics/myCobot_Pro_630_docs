...
#### 1 As shown in the figure, this is the definition of the end tool interface. The robot provides one input and two outputs.
...
The definition of each tool I/O port is shown in the following table. Note that the tool I/O has PNP output and NPN input, and the wiring method is the same as the bottom output interface.
